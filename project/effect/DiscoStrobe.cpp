...
DiscoStrobe::DiscoStrobe(struct CRGB *pLeds) {
	leds = pLeds;
	thisdelay = 30;
...
char* DiscoStrobe::name() {
	return "Disco Strobe";
}

void DiscoStrobe::show() {
...
void DiscoStrobe::doStrobe() {
	// First, we black out all the LEDs
	fill_solid( leds, NUM_LEDS, CRGB::Black);

	// To achieve the strobe effect, we actually only draw lit pixels
...
//                                   period 5      width 2
//
void DiscoStrobe::drawRainbowDashes(
